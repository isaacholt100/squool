...
const table = [
  ...
  fs.writeFile("/Users/isaac/Coding/squool/public/json/periodicTable/symbols.json", JSON.stringify(table.map(e => ({name: e.name, symbol: e.symbol}))), (err) => {
      console.log(err);
  });
/*for (const element of table) {
    fs.writeFile("/Users/isaac/Coding/squool/public/json/periodicTable/" + element.symbol + ".json", JSON.stringify(element), err => {
        if (err) {
            console.log(err);
        }
    })
